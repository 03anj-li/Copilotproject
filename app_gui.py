...
# --- Main App ---
st.markdown("<h1>📑 Startup Pitch Polisher</h1>", unsafe_allow_html=True)
...
# --- Generate Button ---
go = st.button("🚀 Generate", key="generate")
...
st.markdown("---")
st.caption("Built with Streamlit + Gemini · Theme: Amber & Black (Go Digit inspired)")
